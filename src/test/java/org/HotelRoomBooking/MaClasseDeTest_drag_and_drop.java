...
public class MaClasseDeTest_drag_and_drop {
	...
	WebDriverWait wait;
	BDD_outils bdd=new BDD_outils();
	
	@Before
	public void setup() throws Exception {
		bdd.insertData("src/main/resources/datasets/insert_reservation.xml");
		bdd.compareData("reservations", "src/main/resources/datasets/insert_reservation.xml");
		choisirNavigateur(b);
	...
	public void after() throws Exception {
		bdd.deleteAllData("src/main/resources/datasets/delete_reservation.xml");
	}
